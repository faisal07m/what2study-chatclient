	...
	*/
	...
	var ReactCountryFlag = function ReactCountryFlag(_ref) {
	  ...
	  if (svg) {
	    ...
	    return reactExports.createElement("img", Object.assign({}, props, {
	      src: flagUrl,
	      style: _extends({
	  ...
	  return reactExports.createElement("span", Object.assign({
	    role: "img"
	  }, props, {
	    style: _extends({
	      display: 'inline-block',
	...
	var Main = function (props) {
	    ...
	    var _d = reactExports.useState(false), isInputFocused = _d[0], setIsInputFocused = _d[1];
	    var _e = reactExports.useState(""), message = _e[0], setMessage = _e[1];
	    ...
	    var _f = reactExports.useState(initialMessages), messages = _f[0], setMessages = _f[1];
	    var _g = reactExports.useState(false), loading = _g[0], setLoading = _g[1];
	    ...
	    var _h = reactExports.useState(''); _h[0]; var setValue = _h[1];
	    var _j = reactExports.useState(false), dummyValuesSet = _j[0], setDummyValueCounter = _j[1];
	    reactExports.useEffect(function () {
