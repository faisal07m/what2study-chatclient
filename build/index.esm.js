...
var DataProvider = function (props) {
    ...
    var _k = useState(), clientConfig = _k[0], setClientConfig = _k[1]; // config saved by the university in main app
    var _l = useState(false), isClientConfigFetched = _l[0], setIsClientConfigFetched = _l[1];
...
var Main = function (props) {
    ...
    var _e = useState(false), isMicPressed = _e[0], setMic = _e[1];
    var _f = useState(true), browserNotSupp = _f[0], setBrowserSupp = _f[1];
    var _g = useState(""); _g[0]; _g[1];
    var _h = useState(false), isBotVolumeOn = _h[0], setIsBotVolumeOn = _h[1];
    var _j = useState(window.speechSynthesis.getVoices()), voices = _j[0], setVoices = _j[1];
    var _k = useState(); _k[0]; var setEnVoices = _k[1];
    var _l = useState(); _l[0]; var setDeVoices = _l[1];
    useEffect(function () {
    ...
    var _m = useState(glowCSS); _m[0]; _m[1];
    var _o = useState(false), regen = _o[0], setRegen = _o[1];
    var _p = useState(""), message = _p[0], setMessage = _p[1];
