...
import React__default, { createContext, useState, useEffect, useContext, useRef, cloneElement, useCallback, useMemo, createElement, Fragment } from 'react';
...
var DataProvider = function (props) {
    ...
    var _j = useState(EChatLanguage.DE), language = _j[0], setLanguage = _j[1];
    var _k = useState(""), welcomeMsgDE = _k[0], setwelcomeMsgDE = _k[1];
    var _l = useState(""), welcomeMsgEN = _l[0], setwelcomeMsgEN = _l[1];
    var _m = useState(), clientConfig = _m[0], setClientConfig = _m[1]; // config saved by the university in main app
    var _o = useState(false), isClientConfigFetched = _o[0], setIsClientConfigFetched = _o[1];
    ...
    var providerValue = {
        ...
        welcomeMsgDE: welcomeMsgDE,
        setwelcomeMsgDE: setwelcomeMsgDE,
        welcomeMsgEN: welcomeMsgEN,
        setwelcomeMsgEN: setwelcomeMsgEN,
...
var IFrame = function (props) {
    ...
    var _e = useState(null), contentRefIframe = _e[0], setContentRefIframe = _e[1];
    ...
    var _g = useState(getStyles(iframeType, isChatOpen, false, testRequest)), styles = _g[0], setStyles = _g[1];
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [isFirefox &&
                ...
                jsxRuntimeExports.jsx("iframe", __assign$1({ id: "what2studyIDChrome", style: styles }, rest, { 
                    ...
                    // onLoad={ handleLoad }
                    ref: setContentRef }, { children: mountNode && !isFirefox && createPortal(children, mountNode) }))] })
    // <iframe
    //     style={styles}
    //     {...rest}
    //     onLoad={isFirefox ? (e) => setContentRef(e.target) : undefined}
...
var PopupItemFilters = function () {
    ...
    var _a = useState(), lf = _a[0], setLF = _a[1];
    var _b = useState(""), lfValue = _b[0], setLFValue = _b[1];
    useEffect(function () {
...
var Main = function (props) {
    ...
    var _a = useState(initialMessages), messages = _a[0], setMessages = _a[1];
    ...
    var _c = useState(''); _c[0]; var setValue = _c[1];
    var _d = useState(false), dummyValuesSet = _d[0], setDummyValueCounter = _d[1];
    ...
    var _h = useState(false), isInputFocused = _h[0], setIsInputFocused = _h[1];
    var _j = useState(false), isMicPressed = _j[0], setMic = _j[1];
    var _k = useState(true), browserNotSupp = _k[0], setBrowserSupp = _k[1];
    var _l = useState(""); _l[0]; _l[1];
    var _m = useState(false), isBotVolumeOn = _m[0], setIsBotVolumeOn = _m[1];
    var _o = useState(window.speechSynthesis.getVoices()), voices = _o[0], setVoices = _o[1];
    var _p = useState(); _p[0]; var setEnVoices = _p[1];
    var _q = useState(); _q[0]; var setDeVoices = _q[1];
    useEffect(function () {
    ...
    var _r = useState(glowCSS); _r[0]; _r[1];
    var _s = useState(false), regen = _s[0], setRegen = _s[1];
    var _t = useState(""), message = _t[0], setMessage = _t[1];
    useEffect(function () {
...
var TalkToHuman = function (props) {
    ...
    var _b = useState(""), userDescription = _b[0], setDescription = _b[1];
    var _c = useState(""), userEmail = _c[0], setUserEmail = _c[1];
    var _d = useState(""), userMat = _d[0], setUserMat = _d[1];
    var _e = useState(""), userPhone = _e[0], setUserPhone = _e[1];
    var WHAT2STUDY_X_PARSE_APP_ID = "what2study";
    var WHAT2STUDY_BACKEND_URL = "https://www.cpstech.de/functions";
    var _f = useState({
        day: "Sat",
...
var OpenChatButton = function (props) {
    ...
    var _b = useState(styleRNot), styleRotate = _b[0], setStyleRotate = _b[1];
...
var ChatClient = function (props) {
    ...
    if (isClientConfigFetched)
        return (jsxRuntimeExports.jsxs(Fragment, { children: [jsxRuntimeExports.jsx(ChatContainer, __assign$1({}, props)), jsxRuntimeExports.jsx(OpenChatButton, { icon: BsChatQuoteFill })] }));
    return jsxRuntimeExports.jsx(Fragment, {});
};
