...
var DataProvider = function (props) {
    ...
    var _g = useState(ERoute.INTRO), currentRoute = _g[0], setCurrentRoute = _g[1]; // COMMITODO .MAIN
    var _h = useState({
        tone: 0.1,
        sentiment: 1,
        emotiveness: 0.7,
...
var IntroPage = function () {
    ...
    return (jsxRuntimeExports.jsx(Fragment, { children: jsxRuntimeExports.jsx("div", { className: "introScreen-wrapper" }) }));
};
