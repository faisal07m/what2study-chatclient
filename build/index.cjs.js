...
var DataProvider = function (props) {
    ...
    var _k = React.useState(""), welcomeMsgDE = _k[0], setwelcomeMsgDE = _k[1];
    var _l = React.useState(""), welcomeMsgEN = _l[0], setwelcomeMsgEN = _l[1];
    var _m = React.useState(), clientConfig = _m[0], setClientConfig = _m[1]; // config saved by the university in main app
    var _o = React.useState(false), isClientConfigFetched = _o[0], setIsClientConfigFetched = _o[1];
...
var IFrame = function (props) {
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [isFirefox &&
                jsxRuntimeExports.jsx("iframe", __assign$1({ style: styles, id: "what2studyIDFirefox" }, rest, { onLoad: handleLoad }, { children: contentRef && isFirefox && ReactDOM.createPortal(children, contentRef) })), !isFirefox &&
...
var IntroPage = function () {
    ...
    var _e = React.useState(language.toLocaleLowerCase()), langSelection = _e[0], setLangSelection = _e[1];
    React.useEffect(function () {
...
var Main = function (props) {
    ...
    var _a = React.useState(initialMessages), messages = _a[0], setMessages = _a[1];
    ...
    var _c = React.useState(''); _c[0]; var setValue = _c[1];
    var _d = React.useState(false), dummyValuesSet = _d[0], setDummyValueCounter = _d[1];
    ...
    var _j = React.useState(false), isMicPressed = _j[0], setMic = _j[1];
    var _k = React.useState(true), browserNotSupp = _k[0], setBrowserSupp = _k[1];
    var _l = React.useState(""); _l[0]; _l[1];
    var _m = React.useState(false), isBotVolumeOn = _m[0], setIsBotVolumeOn = _m[1];
    var _o = React.useState(window.speechSynthesis.getVoices()), voices = _o[0], setVoices = _o[1];
    var _p = React.useState(); _p[0]; var setEnVoices = _p[1];
    var _q = React.useState(); _q[0]; var setDeVoices = _q[1];
    React.useEffect(function () {
    ...
    var _r = React.useState(glowCSS); _r[0]; _r[1];
    var _s = React.useState(false), regen = _s[0], setRegen = _s[1];
    var _t = React.useState(""), message = _t[0], setMessage = _t[1];
    React.useEffect(function () {
...
var ChatClient = function (props) {
    ...
    if (isClientConfigFetched)
        return (jsxRuntimeExports.jsxs(React.Fragment, { children: [jsxRuntimeExports.jsx(ChatContainer, __assign$1({}, props)), jsxRuntimeExports.jsx(OpenChatButton, { icon: BsChatQuoteFill })] }));
    return jsxRuntimeExports.jsx(React.Fragment, {});
};
